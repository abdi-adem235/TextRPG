...
public class Warrior2 extends Player{
	
	
	static String weapon = "sword";
	String type = "warrior";
	
	public Warrior2(String name, int x, int y) {
	...
	public void attack(Enemy enemy, Player player) {
		System.out.println(this.name+ " attacks with their " +Warrior2.weapon+ "!!!");
